        ...
        <section class="levels__kvarc">
            <div class="container">
                ...
                <div class="room__plan first__floor__kvarc">
                    <img src="<?php the_field('kvarc_4', 3743); ?>" alt="plan">
                </div>
                <div class="interactive__wrapper">
                    <div class="modal__room first__modal__kvarc">
                        ...
                        <div class="table__content">
                            <?php
                                $query = "SELECT * FROM table_kvarc WHERE floor = '4'"; //You don't need a ; like you do in SQL
