...
<section class="levels__atoll">
            <div class="container">
                ...
                <div class="room__plan first__floor__atoll">
                    <img src="<?php the_field('atoll_2', 3746); ?>" alt="plan">
                </div>
                <div class="interactive__wrapper">
                    <div class="modal__room first__modal__atoll">
                        ...
                        <div class="table__content">
                            <?php
                                $query = "SELECT * FROM table_atoll WHERE floor = '2'"; //You don't need a ; like you do in SQL
