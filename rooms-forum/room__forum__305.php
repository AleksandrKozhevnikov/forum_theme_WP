<?php 
/* 
Template name: Помещение 305 Форум
...
<head>
    ...
    <title>Помещение 305 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '305'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('forum_slide_305_1', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_305_2', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_305_3', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_305_4', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_305_5', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_305_6', 2066) ?>" alt="slider"></div>
            </div>
