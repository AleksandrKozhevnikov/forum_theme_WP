<?php 
/* 
Template name: Помещение 601 Форум
...
<head>
    ...
    <title>Помещение 601 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '601'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            <div class="room__back__link">
                <a href="<?php echo get_page_link(30)?>">Назад к таблице</a>
            </div>

            <div class="room__header">
                <div class="room__header__text">
                    <div class="room__text__block">
                        <div class="room__rent__descr">Аренда помещения <?php echo  $row['number'] ?> в <br> БЦ "Форум"</div>
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('forum_slide_601_1', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_601_2', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_601_3', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_601_4', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_601_5', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_601_6', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_601_7', 2066) ?>" alt="slider"></div>
            </div>
