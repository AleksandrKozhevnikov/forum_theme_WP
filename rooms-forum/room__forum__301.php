<?php 
/* 
Template name: Помещение 301 Форум
...
<head>
    ...
    <title>Помещение 301 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '301'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('forum_slide_301_1', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_301_2', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_301_3', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_301_4', 2066) ?>" alt="slider"></div>
            </div>
