<?php 
/* 
Template name: Помещение 110т Форум
...
<head>
    ...
    <title>Помещение 110т Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '110т'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('forum_110t', 2066) ?>" alt="room_plan">
            </div>
