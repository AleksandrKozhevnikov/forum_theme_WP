<?php 
/* 
Template name: Помещение 207 Форум
...
<head>
    ...
    <title>Помещение 207 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '207'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('forum_slide_207_1', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_207_2', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_207_3', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_207_4', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_207_5', 2066) ?>" alt="slider"></div>
            </div>
