<?php 
/* 
Template name: Помещение 703 Форум
...
<head>
    ...
    <title>Помещение 703 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '703'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('forum_703', 2066) ?>" alt="room_plan">
            </div>
