<?php 
/* 
Template name: Помещение 206 Форум
...
<head>
    ...
    <title>Помещение 206 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '206'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('forum_slide_206_1', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_206_2', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_206_3', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_206_4', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_206_5', 2066) ?>" alt="slider"></div>
            </div>
