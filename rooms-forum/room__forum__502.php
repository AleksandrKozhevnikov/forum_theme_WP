<?php 
/* 
Template name: Помещение 502 Форум
...
<head>
    ...
    <title>Помещение 502 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '502'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('forum_slide_502_1', 2066) ?>" alt="slider"></div>
                <div><img src="<?php the_field('forum_slide_502_2', 2066) ?>" alt="slider"></div>
            </div>
