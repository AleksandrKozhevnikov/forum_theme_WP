<?php 
/* 
Template name: Помещение 202 Форум
...
<head>
    ...
    <title>Помещение 202 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '202'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('forum_202', 2066) ?>" alt="room_plan">
            </div>
