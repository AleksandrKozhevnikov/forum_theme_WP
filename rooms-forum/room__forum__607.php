<?php 
/* 
Template name: Помещение 607 Форум
...
<head>
    ...
    <title>Помещение 607 Форум</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_forum WHERE number = '607'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('forum_607', 2066) ?>" alt="room_plan">
            </div>
