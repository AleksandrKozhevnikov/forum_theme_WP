...
<?php 
/* 
Template name: Добавить помещение Форум
*/
?>
...
<div class="container">
    <h2 class="add__header">Добавить помещение: Форум</h2>
...
$query = "
INSERT INTO table_forum (number, type, rooms, area, price, summ, comment, commentmore, floor)
