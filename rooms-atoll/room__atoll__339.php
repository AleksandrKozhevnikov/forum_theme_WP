<?php 
/* 
Template name: Помещение 339 Атолл
...
<head>
    ...
    <title>Помещение 339 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '339'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('atoll_slide_339_1', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_339_2', 2074) ?>" alt="slider"></div>
            </div>
