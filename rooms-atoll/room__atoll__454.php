<?php 
/* 
Template name: Помещение 454 Атолл
...
<head>
    ...
    <title>Помещение 454 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '454'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_454', 2076) ?>" alt="room_plan">
            </div>
