<?php 
/* 
Template name: Помещение 524 Атолл
...
<head>
    ...
    <title>Помещение 524 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '524'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_524', 2078) ?>" alt="room_plan">
            </div>
