<?php 
/* 
Template name: Помещение 350 Атолл
...
<head>
    ...
    <title>Помещение 350 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '350'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            <div class="room__back__link">
                <a href="<?php echo get_page_link(32)?>">Назад к таблице</a>
            </div>

            <div class="room__header">
                <div class="room__header__text">
                    <div class="room__text__block">
                        <div class="room__rent__descr">Аренда помещения <?php echo  $row['number'] ?> в <br> БЦ "Атолл"</div>
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('atoll_slide_350_1', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_2', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_3', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_4', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_5', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_6', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_7', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_8', 2074) ?>" alt="slider"></div>
                <div><img src="<?php the_field('atoll_slide_350_9', 2074) ?>" alt="slider"></div>
            </div>
