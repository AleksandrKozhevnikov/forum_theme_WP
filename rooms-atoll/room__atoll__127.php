<?php 
/* 
Template name: Помещение 127 Атолл
...
<head>
    ...
    <title>Помещение 127 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '127'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_127', 2070) ?>" alt="room_plan">
            </div>
