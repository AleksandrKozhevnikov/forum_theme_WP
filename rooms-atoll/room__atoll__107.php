<?php 
/* 
Template name: Помещение 107 Атолл
...
<head>
    ...
    <title>Помещение 107 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '107'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_107', 2070) ?>" alt="room_plan">
            </div>
