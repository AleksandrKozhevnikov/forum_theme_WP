<?php 
/* 
Template name: Помещение 113 Атолл
...
<head>
    ...
    <title>Помещение 113 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '113'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_113', 2070) ?>" alt="room_plan">
            </div>
