<?php 
/* 
Template name: Помещение 444 Атолл
...
<head>
    ...
    <title>Помещение 444 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '444'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_444', 2076) ?>" alt="room_plan">
            </div>
