<?php 
/* 
Template name: Помещение 223 Атолл
...
<head>
    ...
    <title>Помещение 223 Атолл</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_atoll WHERE number = '223'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('atoll_223', 2072) ?>" alt="room_plan">
            </div>
