<?php 
/* 
Template name: Помещение 641 Кварц
...
<head>
    ...
    <title>Помещение 641 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '641'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_641', 1014) ?>" alt="room_plan">
            </div>
