<?php 
/* 
Template name: Помещение 106 Кварц
...
<head>
    ...
    <title>Помещение 106 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '106'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_106', 351) ?>" alt="room_plan">
            </div>
