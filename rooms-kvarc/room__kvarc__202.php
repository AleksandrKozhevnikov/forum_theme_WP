<?php 
/* 
Template name: Помещение 202 Кварц
...
<head>
    ...
    <title>Помещение 202 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '202'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_202', 1002) ?>" alt="room_plan">
            </div>
