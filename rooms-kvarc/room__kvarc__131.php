<?php 
/* 
Template name: Помещение 131 Кварц
...
<head>
    ...
    <title>Помещение 131 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '131'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_131', 351) ?>" alt="room_plan">
            </div>
