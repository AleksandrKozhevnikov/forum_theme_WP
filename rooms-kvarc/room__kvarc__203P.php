<?php 
/* 
Template name: Помещение 203П Кварц
...
<head>
    ...
    <title>Помещение 203П Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '203П'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('kvarc_slide_203p_1', 1002) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_203p_2', 1002) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_203p_3', 1002) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_203p_4', 1002) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_203p_5', 1002) ?>" alt="slider"></div>
            </div>
