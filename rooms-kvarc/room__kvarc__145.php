<?php 
/* 
Template name: Помещение 145 Кварц
...
<head>
    ...
    <title>Помещение 145 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '145'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('kvarc_slide_145_1', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_145_2', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_145_3', 351) ?>" alt="slider"></div>
            </div>
