<?php 
/* 
Template name: Помещение 506 Кварц
...
<head>
    ...
    <title>Помещение 506 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '506'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_506', 1012) ?>" alt="room_plan">
            </div>
