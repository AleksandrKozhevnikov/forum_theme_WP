<?php 
/* 
Template name: Помещение 004 Кварц
...
<head>
    ...
    <title>Помещение 004 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '004'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('kvarc_slide_004_1', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_2', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_3', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_4', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_5', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_6', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_7', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_8', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_9', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_10', 351) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_004_11', 351) ?>" alt="slider"></div>
            </div>
