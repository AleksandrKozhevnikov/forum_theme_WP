<?php 
/* 
Template name: Помещение 257 Кварц
...
<head>
    ...
    <title>Помещение 257 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '257'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_257', 1002) ?>" alt="room_plan">
            </div>
