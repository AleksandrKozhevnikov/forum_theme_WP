<?php 
/* 
Template name: Помещение 202П Кварц
...
<head>
    ...
    <title>Помещение 202П Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '202П'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_202P', 1002) ?>" alt="room_plan">
            </div>
