<?php 
/* 
Template name: Помещение 204П Кварц
...
<head>
    ...
    <title>Помещение 204П Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '204П'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__slider">
                <div><img src="<?php the_field('kvarc_slide_204p_1', 1002) ?>" alt="slider"></div>
                <div><img src="<?php the_field('kvarc_slide_204p_2', 1002) ?>" alt="slider"></div>
            </div>
