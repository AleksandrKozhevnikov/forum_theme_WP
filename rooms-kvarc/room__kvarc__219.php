<?php 
/* 
Template name: Помещение 219 Кварц
...
<head>
    ...
    <title>Помещение 219 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '219'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_219', 1002) ?>" alt="room_plan">
            </div>
