<?php 
/* 
Template name: Помещение 438 Кварц
...
<head>
    ...
    <title>Помещение 438 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '438'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_438', 1010) ?>" alt="room_plan">
            </div>
