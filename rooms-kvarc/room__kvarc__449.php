<?php 
/* 
Template name: Помещение 449 Кварц
...
<head>
    ...
    <title>Помещение 449 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '449'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_449', 1010) ?>" alt="room_plan">
            </div>
