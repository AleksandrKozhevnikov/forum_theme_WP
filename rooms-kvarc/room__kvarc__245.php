<?php 
/* 
Template name: Помещение 245 Кварц
...
<head>
    ...
    <title>Помещение 245 Кварц</title>
</head>
...
<?php 
    $query = "SELECT * FROM table_kvarc WHERE number = '245'"; //You don't need a ; like you do in SQL
...
<section class="room">
        <div class="container">
            ...
            <div class="room__plan__image__wrapper">
                <img class="room__plan__image" src="<?php the_field('kvarc_245', 1002) ?>" alt="room_plan">
            </div>
