...
<section class="levels__forum">
            <div class="container">
                ...
                <div class="room__plan first__floor__forum">
                    <img src="<?php the_field('forum_3', 3741); ?>" alt="plan">
                </div>
                ...
                <div class="interactive__wrapper">
                    <div class="modal__room first__modal__forum">
                        ...
                        <div class="table__content">
                            <?php
                                $query = "SELECT * FROM table_forum WHERE floor = '3'"; //You don't need a ; like you do in SQL
