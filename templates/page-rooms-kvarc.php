<?php 
/* 
Template name: Свободные помещения Кварц
*/
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <?php 
        wp_head();
    ?>
    <title>Форум РФ - Помещения Кварц</title>
</head>
<?php 
    get_header();
            ...
            <div class="container">
                ...
                <div class="rent__choice rent__choice__large">
                    ...
                    <form id="table__form__kvarc" method="post">
                        ...
                        <div class="choice__rent-pay">
                            ...
                            <button id="submit__button__kvarc" type="button" name="sendFormButton" class="button__orange button__orange_filter_center">Найти</button>
                        </div>
                    </form>
                </div>
                <div class="table__large__content">
                    <?php 
                            ...
                            $query = "SELECT * FROM table_kvarc WHERE area BETWEEN 11 AND 500 AND summ BETWEEN 5250 AND 125860";
                            $result = mysqli_query($connection,$query);
                            
                            echo "<table class='table table__large sort'>
                                    <thead>
