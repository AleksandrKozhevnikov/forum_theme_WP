<?php 
/* 
Template name: Свободные помещения Атолл
*/
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <title>Форум РФ - Помещения Атолл</title>
</head>
<?php 
    get_header();
            ...
            <div class="container">
                ...
                <div class="rent__choice rent__choice__large">
                    ...
                    <form id="table__form__atoll" method="post">
                        ...
                        <div class="choice__rent-pay">
                            ...
                            <button id="submit__button__atoll" type="button" name="sendFormButton" class="button__orange button__orange_filter_center">Найти</button>
                        </div>
                    </form>
                </div>
                <div class="table__large__content">
                    <?php 
                            ...
                            $query = "SELECT * FROM table_atoll WHERE area BETWEEN 11 AND 500 AND summ BETWEEN 5250 AND 125860";
                            ...
                            echo "      <tr>
                                            <td><a target='_blank'  href='https://www.kozhevnikov97.ru/pomeshhenie-" . $row['number'] . "-atoll/'>" . $row['number'] . "</a></td>
                                            <td>" . $row['type'] . "</td>
                                            <td>" . $row['rooms'] . "</td>
                                            <td>" . $row['area'] . "</td>
                                            <td>" . $row['price'] . "</td>
