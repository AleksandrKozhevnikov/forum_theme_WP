<?php 
/* 
Template name: Блок продажа 6 левый
        ...
        <div class="container">
            <div class="more__wrapper">
                <div class="more__text">
                    ...
                    <hr>
                    <p> 
                        <?php the_field('card_6_descr', 18) ?>
                    </p>
                    <h2 class="more__text__header">Характеристики:</h2>
                    <hr>
                    <p> <b>Общая площадь:</b> — <?php the_field('card_6_area', 18) ?>
                        <br>
                        <?php the_field('card_6_feature', 18) ?>
                    </p>
                    <?php 
                        $rent = get_field('card_6_rent', 18);
                ...
                <div class="more__media">
                    <h2 class="more__adress"><?php the_field('card_6_adress', 18) ?></h2>
                    <div class="more__slider">
                    <?php 
                            $slide2 = get_field('card_6_slide_2', 18);
                            $slide3 = get_field('card_6_slide_3', 18);
                            $slide4 = get_field('card_6_slide_4', 18);
                            $slide5 = get_field('card_6_slide_5', 18);
                        ?>
                        <img src="<?php the_field('card_6_slide_1', 18) ?>">
                        <?php 
                            if (!empty($slide2)) {
                                ?>
